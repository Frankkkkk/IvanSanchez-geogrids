...
var count = pokes.length;

var precisionPerPoke = Math.log2(count);
...
for (var i = precisionPerPoke; i < 60; i+= precisionPerPoke) {
	precisions.push(i);
}
...
// 	let matches = [];
	...
	while ((match = regexp.exec(str)) !== null) {
		let position = pokes.indexOf(match[1]);
		if (position === -1) {
			if (precision) {
